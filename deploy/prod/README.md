...
## Important note about TURN/STUN
...
Client server URL (my private server):

- `https://rsmsg.kevindev64.ru`

Client ICE settings when TURN is enabled (my closed server):

- `stun:rsmsg.kevindev64.ru:3478`

- `turn:rsmsg.kevindev64.ru:3478`

TURN auth data should be received from me by email.
